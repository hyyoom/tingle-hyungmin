...
public class StarProductController {
    ...
    public ResponseEntity<?> createProductNoFile(@RequestParam("productDto") String productDtoJson) {
        try {
            ...
            List<ProductImageEntity> imageEntities = new ArrayList<>();
            imageEntities.add(new ProductImageEntity("https://navi.s3.ap-northeast-2.amazonaws.com/basic-product.png", null)); // S3 URL 사용
    ...
    public String updateProduct(@RequestParam("productDto") String productDtoJson,
        ...
        for (ProductImageEntity image : filteredImageUrls) {
            if (image.getId() != null) {
                ...
                if (!image.getUrl().equals("https://navi.s3.ap-northeast-2.amazonaws.com/basic-product.png")) {
    ...
    public String updateProductNoPre(@RequestParam("productDto") String productDtoJson) throws IOException {
        ...
        imageUrls.add(new ProductImageEntity("https://navi.s3.ap-northeast-2.amazonaws.com/basic-product.png", product));
