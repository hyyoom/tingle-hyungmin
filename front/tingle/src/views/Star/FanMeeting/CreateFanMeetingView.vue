<template>
  <main class="container my-5 mx-5">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-8 d-flex">
            <VueDatePicker
              ...
              :min-date="ticketingStartMinDate"
              locale="ko"
        ...
        <div class="row">
          ...
          <div class="col-md-8 d-flex mb-4">
            <VueDatePicker
              ...
              :min-date="fanMeetingStartMinDate"
              locale="ko"
              :time-picker-inline="true"
              :is-24="false"
            >
    ...
    <div class="row">
      <div class="col-md-6">
        <div
          ...
          @drop.prevent="handleDrop($event, 'file1')"
      ...
      <div class="col-md-6">
        <div
          ...
          class="tw-border-dashed tw-border-2 tw-border-primary tw-p-4 tw-text-center tw-cursor-pointer tw-mb-4"
          @dragover.prevent="handleDragOver"
          @drop.prevent="handleDrop($event, 'file2')"
    ...
    <div class="col-12 text-center mt-4">
      <button @click="createFanMeetingSequence" class="btn btn-primary btn-lg">
        팬미팅 만들기
      </button>
    </div>
  </main>
...
const toggleContent = (content: FanMeetingType) => {
  const indexInMeeting = meeting.value.availableFanMeetingTypes.findIndex(
